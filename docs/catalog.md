...
| DevTools / OpenClaw | 5 | First-run setup, Gateway operations, security audit, and channel safety workflows. |
...
| [Setup OpenClaw Peekaboo First Run](../reactions/devtools/openclaw/ecosystem/peekaboo/setup-openclaw-peekaboo-first-run.reaction.md) | `/ReAction-setup-openclaw-peekaboo-first-run` | advanced | OpenClaw, Peekaboo, Native Tools, macOS, MCP, Screenshots, UI Inspection, Accessibility, Screen Recording | static, terminal, manual-review, permission-check, screenshot-smoke-test, ui-inspection-smoke-test, redaction | [Setup OpenClaw First Run](../reactions/devtools/openclaw/setup-openclaw-first-run.reaction.md) |
| [Check OpenClaw Peekaboo Permissions Health](../reactions/devtools/openclaw/ecosystem/peekaboo/check-openclaw-peekaboo-permissions-health.reaction.md) | `/ReAction-check-openclaw-peekaboo-permissions-health` | intermediate | OpenClaw, Peekaboo, Native Tools, macOS, Screen Recording, Accessibility, Event Synthesizing, Bridge, MCP, Read-only | static, terminal, manual-review, permission-check, all-sources-permission-check, bridge-local-mismatch-check, redaction | [Setup OpenClaw Peekaboo First Run](../reactions/devtools/openclaw/ecosystem/peekaboo/setup-openclaw-peekaboo-first-run.reaction.md) |
| [Run OpenClaw Peekaboo UI Capture Smoke Test](../reactions/devtools/openclaw/ecosystem/peekaboo/run-openclaw-peekaboo-ui-capture-smoke-test.reaction.md) | `/ReAction-run-openclaw-peekaboo-ui-capture-smoke-test` | intermediate | OpenClaw, Peekaboo, Native Tools, macOS, Screenshots, UI Inspection, Annotated UI Map, JSON Output, Privacy | static, terminal, manual-review, screenshot-smoke-test, ui-inspection-smoke-test, privacy-check, redaction | [Setup OpenClaw Peekaboo First Run](../reactions/devtools/openclaw/ecosystem/peekaboo/setup-openclaw-peekaboo-first-run.reaction.md), [Check OpenClaw Peekaboo Permissions Health](../reactions/devtools/openclaw/ecosystem/peekaboo/check-openclaw-peekaboo-permissions-health.reaction.md) |
| [Check OpenClaw Peekaboo MCP Health](../reactions/devtools/openclaw/ecosystem/peekaboo/check-openclaw-peekaboo-mcp-health.reaction.md) | `/ReAction-check-openclaw-peekaboo-mcp-health` | intermediate | OpenClaw, Peekaboo, Native Tools, MCP, stdio, npm, local binary, Codex, Claude Code, Cursor, Tool Exposure, Secret Redaction | static, terminal, manual-review, mcp-config-check, stdio-transport-check, tool-exposure-check, permission-check, secret-redaction-check, redaction | [Setup OpenClaw Peekaboo First Run](../reactions/devtools/openclaw/ecosystem/peekaboo/setup-openclaw-peekaboo-first-run.reaction.md), [Check OpenClaw Peekaboo Permissions Health](../reactions/devtools/openclaw/ecosystem/peekaboo/check-openclaw-peekaboo-permissions-health.reaction.md), [Run OpenClaw Peekaboo UI Capture Smoke Test](../reactions/devtools/openclaw/ecosystem/peekaboo/run-openclaw-peekaboo-ui-capture-smoke-test.reaction.md) |
...
| [Setup OpenClaw Peekaboo First Run](../reactions/devtools/openclaw/ecosystem/peekaboo/setup-openclaw-peekaboo-first-run.reaction.md) | advanced | high | false | inspect-operating-system, inspect-current-directory, run-commands, read-stdout, read-stderr, detect-cli-availability, detect-macos-permissions, ask-confirmation, capture-safe-screenshot, inspect-safe-ui-tree, plan-mcp-config, redact-secrets, final-report | devtools, openclaw, openclaw-ecosystem, peekaboo, native-tools, first-run, setup, macos, mcp, screenshots, ui-inspection, clicks, accessibility, screen-recording, confirmation-gates, redaction |
| [Check OpenClaw Peekaboo Permissions Health](../reactions/devtools/openclaw/ecosystem/peekaboo/check-openclaw-peekaboo-permissions-health.reaction.md) | intermediate | high | true | inspect-operating-system, run-read-only-terminal-commands, detect-cli-availability, detect-macos-permissions, parse-permission-status, compare-permission-sources, detect-bridge-local-mismatch, classify-permission-readiness, ask-confirmation, redact-secrets, final-report | devtools, openclaw, openclaw-ecosystem, peekaboo, native-tools, permissions, macos, screen-recording, accessibility, event-synthesizing, bridge, node-subprocess, mcp, screenshots, ui-inspection, read-only, redaction |
| [Run OpenClaw Peekaboo UI Capture Smoke Test](../reactions/devtools/openclaw/ecosystem/peekaboo/run-openclaw-peekaboo-ui-capture-smoke-test.reaction.md) | intermediate | high | false | inspect-operating-system, run-terminal-commands, detect-cli-availability, check-permission-status, ask-confirmation, capture-safe-screenshot, inspect-safe-ui-tree, parse-json-summary, redact-private-ui-text, produce-smoke-test-report | devtools, openclaw, openclaw-ecosystem, peekaboo, native-tools, ui-capture, screenshots, ui-inspection, see, image, annotate, json, macos, screen-recording, accessibility, privacy, smoke-test, redaction |
| [Check OpenClaw Peekaboo MCP Health](../reactions/devtools/openclaw/ecosystem/peekaboo/check-openclaw-peekaboo-mcp-health.reaction.md) | intermediate | high | true | inspect-operating-system, run-read-only-terminal-commands, detect-cli-availability, detect-mcp-command-availability, check-permission-status, inspect-tool-catalog, parse-mcp-config-shape, detect-stdio-transport, detect-npm-launch-config, detect-local-binary-launch-config, detect-unsupported-transport, detect-secret-exposure, ask-confirmation, redact-secrets, produce-mcp-health-report | devtools, openclaw, openclaw-ecosystem, peekaboo, native-tools, mcp, stdio, codex, claude-code, cursor, npm, npx, local-binary, permissions, tool-exposure, security, redaction, read-only |
