...
| Setup Bun Test Runner | `/ReAction-setup-bun-test-runner` | You want to safely add or improve a Bun test setup for a JavaScript/TypeScript project with planning, confirmation gates, and verification. |
