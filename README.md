...
|---|---|---|
| NCERT Class 8 Mathematics Tutor Responsibility | `/ReAction-assume-ncert-class-8-math-tutor-responsibility` | You want an agent to tutor Class 8 Mathematics using only NCERT Mathematics textbook material, NCERT-based teacher notes, or NCERT-based student notes. |
  ...
  devtools/
    ...
    bun/
      *.reaction.md
      README.md
    openclaw/
      setup-openclaw-first-run.reaction.md
      README.md
      ecosystem/
        peekaboo/
          setup-openclaw-peekaboo-first-run.reaction.md
          README.md
    hermes/
      *.reaction.md
      README.md
